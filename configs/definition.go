...
const (
	...
	WEB_API_APP_PROFILE_WOW_GAMING_PROD        string = "app_profile_wow_gaming_prod"
	WEB_API_APP_PROFILE_WOW_GAMING_STAGING     string = "app_profile_wow_gaming_staging"
	WEB_API_APP_PROFILE_AI_LIVE_CASINO_PROD    string = "app_profile_ai_live_casino_prod"
	WEB_API_APP_PROFILE_AI_LIVE_CASINO_STAGING string = "app_profile_ai_live_casino_staging"
